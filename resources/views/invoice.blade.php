                ...
                <div class="col-12">
                        ...
                        <div class="invoice p-3 mb-3">
                          ...
                          <div class="row">
                            <div class="col-12">
                              <h4>
                                <i class="fa fa-globe"></i> Okandeji, Inc.
                                <small class="float-right">Date: {{date("l  F j, Y.")}}</small>
                              </h4>
                            </div>
                            <!-- /.col -->
                          </div>
                          ...
                          <div class="row invoice-info">
                            <div class="col-sm-4 invoice-col">
                              From
                              <address>
                                <strong>Okandeji, Inc.</strong><br>
                                26 Tide Gate, Ijora Kingdom<br>
                                Lagos, Nigeria.<br>
                                Phone: (234) 07087828631<br>
                            ...
                            <div class="col-sm-4 invoice-col">
                              ...
                              <b>Payment Due:</b> {{date("F j, Y, g:i a")}}<br>
                          ...
                          <div class="row">
                            ...
                            <!-- /.col -->
                            <div class="col-6">
                              <p class="lead">Amount Due {{date("F j, Y, g:i a")}}</p>
