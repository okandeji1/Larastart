...
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/welcome" class="brand-link">
      <img src="./img/tinder.png" alt="LaraStart Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- <li class="nav-item"><a class="nav-link" href="./welcome"><i class="nav-icon fas fa-home"></i>Home</a></li> --}}
            <li class="nav-item">
  ...
  <footer class="main-footer">
    <!-- Default to the left -->
    <strong class="text-center">Copyright &copy; 2018 Okandeji</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
